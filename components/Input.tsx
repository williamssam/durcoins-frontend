		...
		<div>
			<label className='relative'>
				<input
					...
					required
					autoComplete='false'
					className='py-1 w-full text-gray-900 border-b-2 border-b-gray-400 outline-none focus:border-gray-400 transition duration-200 peer valid:border-blue-600'
				/>
