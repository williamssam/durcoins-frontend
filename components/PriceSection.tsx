export const PriceSection = () => {
	return (
		...
		<section className='col-span-2 bg-gray-900 my-4 shadow-xl rounded-lg p-5 md:p-10'>
			<ul className='flex flex-col gap-3'>
				<li className='flex items-center justify-between bg-gray-100 rounded-md py-4 px-6'>
